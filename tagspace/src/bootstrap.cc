...
tagd::code bootstrap::init_hard_tags(tagspace& TS) {
	...
	PUT_OR_DIE(HARD_TAG_SUPER, HARD_TAG_ENTITY, tagd::POS_SUPER_RELATOR)
	...
	PUT_OR_DIE(HARD_TAG_RELATOR, HARD_TAG_ENTITY, tagd::POS_RELATOR)
	...
	PUT_OR_DIE(HARD_TAG_URL, HARD_TAG_ENTITY, tagd::POS_TAG)
	PUT_OR_DIE(HARD_TAG_INTERROGATOR, HARD_TAG_ENTITY, tagd::POS_INTERROGATOR) 
	...
	PUT_OR_DIE(HARD_TAG_PUBLIC, HARD_TAG_URL_PART, tagd::POS_TAG) 
	PUT_OR_DIE(HARD_TAG_SUBDOMAIN, HARD_TAG_URL_PART, tagd::POS_TAG) 
	...
	PUT_OR_DIE(HARD_TAG_ERROR, HARD_TAG_ENTITY, tagd::POS_TAG)
	PUT_OR_DIE(HARD_TAG_MESSAGE, HARD_TAG_ENTITY, tagd::POS_TAG)
	PUT_OR_DIE(HARD_TAG_CAUSED_BY, HARD_TAG_RELATOR, tagd::POS_RELATOR)
	PUT_OR_DIE(HARD_TAG_UNKNOWN_TAG, HARD_TAG_ENTITY, tagd::POS_TAG)
	PUT_OR_DIE(HARD_TAG_BAD_TOKEN, HARD_TAG_ENTITY, tagd::POS_TAG)
	PUT_OR_DIE(HARD_TAG_LINE_NUMBER, HARD_TAG_ENTITY, tagd::POS_TAG)
